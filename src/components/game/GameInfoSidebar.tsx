...
function DoorExitIcon({ className }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden
    >
      <path fill="currentColor" fillOpacity={0.25} d="M4 4h12v16H4V4z" />
      <path
        stroke="currentColor"
        strokeWidth={1.75}
  ...
  const buyIncomeUpgrade = () => {
    setEco((e) => {
      ...
      return {
        ...
        nextUpgradeCost: Math.ceil(
          e.nextUpgradeCost * INCOME_UPGRADE_PRICE_MULT,
        ),
      };
    });
  };
          ...
          {expanded ? (
            ...
            >
              ...
              <div className="flex flex-col gap-2 rounded-lg border border-rose-500/25 bg-rose-950/20 p-3">
                ...
                <p className="text-[11px] leading-snug text-zinc-400">
                  +{DAMAGE_BONUS_PER_PURCHASE} ataque a todas tus unidades
                  (actuales y nuevas). Bonus total:{" "}
